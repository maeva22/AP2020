...
$resultat = $cnx->prepare("select * FROM article INNER JOIN categorie ON article.ID_CAT=categorie.ID_CAT INNER JOIN internaute ON internaute.ID_UT=article.ID_CONT WHERE STATUS_ART='R';");
