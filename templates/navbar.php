...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <div class="navbar-nav lienMetier">
              ...
              <li class="nav-item dropdown">
               ...
               Developement
                ...
                <?php foreach($lignes as $arts) {
                  ...
                  $_SESSION['art']=$arts;
                  ?>
                     <a class  ="dropdown-item" href="<?php echo "../metier/metier.php?ida=".$_SESSION['art']['ID_ART']; ?>"><?php echo $arts['TITRE_ART'];?></p></a>
                  <?php }}?>
                </div>
              </li>
            </ul>
            ...
            <a class="nav-link" href="../administrateur/front_end/connexion_administrateur.php">Administrateurs</a>
        </div>
    </div>
</nav>